...
/*   Updated: 2025/04/04 15:22:10 by aadyan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	mouse_zoom(t_mlx *mlx, int keycode, int x, int y)
{
	...
	mlx->props->shift_x -= (x - center_x) / WIN_SIZE * 2 * (mlx->props->zoom - prev_zoom);
	mlx->props->shift_y -= (y - center_y) / WIN_SIZE * 2 * (mlx->props->zoom - prev_zoom);
}
